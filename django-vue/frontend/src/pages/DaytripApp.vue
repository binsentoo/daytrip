...
<template>
  <div class="bg-stone-50 flex flex-col h-screen">
    <HeaderComp />
    <div class="grid grid-cols-2 grid-rows-2 flex-1 gap-8 py-6 px-15">
      <TripOverview :code="code" />
      <LocationLister :code="code" />
      <AddAttendees :code="code" />
    </div>
  </div>
</template>
