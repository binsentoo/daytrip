<template>
  <div class="relative bg-white px-10 pt-10 pb-8 shadow-xl ring-1 ring-gray-900/5 mx-auto max-w-lg rounded-lg">
    ...
    <div v-if="editMode" class="flex pb-1">
      <input v-model="tempValue" maxlength="25" class="font-serif text-2xl focus:text-gray-500 text-gray-400 border-2 border-gray-700"/>
